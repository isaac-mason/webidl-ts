...
function printEmscriptenModule(moduleName, nodes, defaultExport) {
    ...
    /* type           */ ts.factory.createTypeReferenceNode('Promise', [
        ts.factory.createIntersectionTypeNode([ts.factory.createTypeReferenceNode('T', []), ts.factory.createTypeQueryNode(ts.factory.createIdentifier(moduleName))]),
    ]), 
    /* body           */ undefined));
...
function emscriptenAdditions() {
    ...
    /* name           */ 'destroy', 
    /* typeParameters */ [], 
    /* parameters     */ [ts.factory.createParameterDeclaration([], undefined, 'obj', undefined, ts.factory.createKeywordTypeNode(ts.SyntaxKind.AnyKeyword))], 
    ...
    result.push(ts.factory.createFunctionDeclaration(
    // undefined,
    undefined, undefined, ts.factory.createIdentifier('_malloc'), undefined, [
        ts.factory.createParameterDeclaration(
        // undefined,
        undefined, undefined, ts.factory.createIdentifier('size'), undefined, ts.factory.createKeywordTypeNode(ts.SyntaxKind.NumberKeyword), undefined),
    ...
    result.push(ts.factory.createFunctionDeclaration(
    // undefined,
    undefined, undefined, ts.factory.createIdentifier('_free'), undefined, [
        ts.factory.createParameterDeclaration(
        // undefined,
        undefined, undefined, ts.factory.createIdentifier('ptr'), undefined, ts.factory.createKeywordTypeNode(ts.SyntaxKind.NumberKeyword), undefined),
